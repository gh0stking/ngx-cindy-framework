...
import { CindyHeader } from '../../common/shared';
...
export class CindyAccordion implements BlockableUI {
    ...
    public tabs: CindyAccordionTab[] = [];

    constructor(public el: ElementRef) { }

    addTab(tab: CindyAccordionTab) {
        this.tabs.push(tab);
    }
...
export class CindyAccordionTab implements OnDestroy {
    ...
    @ContentChildren(CindyHeader) headerFacet: QueryList<CindyAccordionTab>;

    public animating: boolean;

    constructor(public accordion: CindyAccordion) {
